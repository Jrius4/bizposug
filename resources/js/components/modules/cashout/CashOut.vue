            ...
            <v-form ref="form">
              <v-card elevation="4">
                ...
                <v-card-text>
                  <v-select
                    ref="typeofSale"
                    :rules="[() => !!typeofSale || 'Type is required']"
                    :menu-props="{
                      bottom: true,
                      offsetY: true,
                    }"
            ...
            <v-dialog v-model="editor" persistent max-width="320">
              <v-card>
                <v-form ref="productEditor">
                  ...
                  <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn color="red darken-3" text @click="cancelProduct"
                      >Disagree</v-btn
                    >
                    <v-btn color="green darken-2" text @click="editProduct"
                      >Agree</v-btn
                    >
                  </v-card-actions>
                </v-form>
